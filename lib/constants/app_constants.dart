...
class AppConstats {
  ...
  // static const DepertmentView = '/dept';
  ...
  static const DepartmentDetailsview = '/deptdetail';
  static const StudentDetailsView = '/studentdetailsview';
  static const TeacherView = '/teacherview';
  static const WebPageView = '/webpageview';
